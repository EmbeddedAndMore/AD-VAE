...
class BaseModel(ABC):
    ...
    def save_networks(self, epoch):
        ...
        save_encoder_filename = f'{self.model_name}_e_{epoch}.pth'
        save_decoder_filename = f'{self.model_name}_d_{epoch}.pth'
        ...
        if len(self.gpu) > 0 and torch.cuda.is_available():
            ...
            print("encoder saved in: ", save_encoder_path)
            print("decoder saved in: ", save_decoder_path)
        else:
    ...
    def load_networks(self, opt):
        load_encoder_filename = f'{opt.trained_encoder_name}'
        load_decoder_filename = f'{opt.trained_decoder_name}'
